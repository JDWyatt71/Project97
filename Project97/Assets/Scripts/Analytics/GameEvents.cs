...
public static class GameEvents
{
    ...
    public static event Action<string, string, string, string, int, string> MoveUsed;
    ...
    public static void RaiseStageComplete(string fightID, string sessionId) => StageComplete?.Invoke(fightID, sessionId); 
    public static void RaiseStageFail(string fightID, string sessionId) => StageFail?.Invoke(fightID, sessionId);
    public static void RaiseMoveUsed(string move, string sessionId, string user, string attackRes, int damage, string target) => MoveUsed?.Invoke(move, sessionId, user, attackRes, damage, target);
